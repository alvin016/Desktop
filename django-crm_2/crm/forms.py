...
from .models import Customer,Activity,CustomerProductStatus, ProductStatusOption
...
class CustomerProductStatusForm(forms.ModelForm):
    class Meta:
        model = CustomerProductStatus
        fields = ['status_options']
        widgets = {

            'status_options': forms.CheckboxSelectMultiple,
        }